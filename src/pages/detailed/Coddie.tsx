...
export default function Tucome() {
  return (
    <div className="pt-[185px] font-segoe_ui mx-[3%]">
      <Navbar />
      <h1 data-aos="fade-up" className="font-segoe_ui text-transparent bg-gradient-to-tl from-lime-300 via-lime-500 to-lime-600 bg-clip-text font-extrabold text-center items-center text-[128px]">
        Coddie
      </h1>
      ...
      <div data-aos="fade-up" className="bg-gradient-to-br from-lime-300 via-lime-500 to-lime-600 w-full rounded-2xl py-12 flex flex-wrap gap-10 items-center justify-center mb-10">
      ...
      <div data-aos="fade-up" className="bg-gradient-to-l from-lime-300 via-lime-500 to-lime-600 w-full rounded-2xl py-12 items-center justify-center mb-10 text-white px-[150px] ">
      ...
      <h1 data-aos="fade-up" className="text-[64px] font-extrabold  text-white pb-5 px-[150px]">
        Competitor Analysis
      </h1>
