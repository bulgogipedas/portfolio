...
export default function Tucome() {
  return (
    <div  className="pt-[185px] font-segoe_ui mx-[3%]">
      <Navbar />
      <h1 data-aos="fade-up"className="font-segoe_ui text-transparent bg-gradient-to-br from-[#53963C] via-[#72CA3C] to-[#E2E548] bg-clip-text font-extrabold text-center items-center text-[128px]">
        NutriSync
      </h1>
      ...
      <div data-aos="fade-up" className="bg-gradient-to-br from-[#53963C] via-[#72CA3C] to-[#E2E548] w-full rounded-2xl py-12 flex flex-wrap gap-10 items-center justify-center mb-10">
      ...
      <div className=" text-white pb-5 px-[150px]">
        ...
        <p cdata-aos="fade-up" className="text-[18px]  text-justify   ">
      ...
      <div data-aos="fade-up" className="bg-gradient-to-r from-[#53963C] via-[#72CA3C] to-[#E2E548] w-full rounded-2xl py-12 items-center justify-center mb-10 text-white px-[150px] ">
